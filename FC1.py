        ...
        if remittance_file:
            try:
                ...
                if not all(col in remit_df.columns for col in required_remit_cols):
                    ...
                    # Rename 'shop_order_id' to 'PO' to match with final_df
                    ...
                    # Ensure all new columns are string to avoid Excel errors
                    columns_to_convert = ['paid_date', 'disputed_date', 'paid_amount',
                                          'disputed_amount', 'dispute_reason', 'payment_details']
