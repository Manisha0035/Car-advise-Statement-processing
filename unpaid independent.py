...
if uploaded_file:
    ...
    if not all(col in df.columns for col in required_cols):
        ...
        # Insert blank 'AI trans Fee' and 'FMC Rebate' columns between 'Tax Total' and 'Payable Amount'
        ...
        # Define desired column order (including owed_pretax, owed_tax_ai, rebate, Accurals)
        desired_order = [
            'Appointment date', 'Appointment month', 'Appointment year', 'Vendor Name',
            'PO', 'ROID', 'Invoice no', 'VIN', 'owed_pretax', 'owed_tax_ai', 'rebate', 'Accurals','Sub Total', 'Tax Total', # Additional fields to retain
            'AI trans Fee', 'FMC Rebate', 'Payable Amount',
            'Rebate AI', 'Rebate%', 'Amount to pay',
